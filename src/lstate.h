 ...
 * @功能分类: 虚拟机运转的核心功能
 * @注释者: frog-game
 * @LastEditTime: 2023-02-21 23:36:16
 */
/*
** $Id: lstate.h $
** Global State
...
typedef struct global_State {
  ...
  lu_mem lastatomic;  /* see function 'genstep' in file 'lgc.c' *///原子扫描方式下的统计的垃圾量
  ...
  lu_byte genminormul;  /* control for minor generational collections *///分代局部GC 默认值是20
  lu_byte genmajormul;  /* control for major generational collections *///分代完整GC 默认值是100
  ...
  lu_byte gcstepsize;  /* (log2 of) GC granularity *///在下一个GC步骤之前这次GC回收内存对应的Tvalue量
